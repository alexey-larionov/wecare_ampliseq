...
clean_bam_folder="${data_folder}/d04_clean_bams/bam"
picard_folder=="${data_folder}/d04_clean_bams/picard"
...
# Make batches of 25 samples each (store temporary files in output folder)
cd "${clean_bam_folder}"
split -l 25 <<< "${samples}"
batches=$(ls)
