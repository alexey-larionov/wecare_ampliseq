...
# 2) After the preliminary assessment strict VQSR TS settings were adopted (95 for SNPs and for 90 INDELs)
...
vqsr_folder="${data_folder}/d07_filtered_vcf_v03/vqsr"
vqsr_tmp_folder="${data_folder}/d07_filtered_vcf_v03/vqsr/misc"
