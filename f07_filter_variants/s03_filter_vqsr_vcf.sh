...
# s03_filter_vqsr_vcf.sh
# Started: Alexey Larionov, 08Aug2018
# Last updated: Alexey Larionov, 08Aug2018

# Use:
# sbatch s03_filter_vqsr_vcf.sh
...
#SBATCH --output=s03_filter_vqsr_vcf.log
#SBATCH --ntasks=4
#SBATCH --qos=INTR
...
# Start message
echo "Filter VCF using pre-selected target variants"
date
echo ""
...
input_folder="${data_folder}/d07_filtered_vcf/vqsr"
output_folder="${data_folder}/d07_filtered_vcf/bcftools"
# output_folder contains targets.txt file with pre-selected 8,745 variants

# Files
source_vcf="${input_folder}/wecare_ampliseq_vqsr.vcf"
filtered_vcf="${output_folder}/wecare_ampliseq_filt_8745.vcf"
targets_file="${output_folder}/targets.txt"
